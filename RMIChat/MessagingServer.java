...
public class MessagingServer {
    ...
    public MessagingServer() {
        try {
            MessagingImpl csi = new MessagingImpl(this);
    ...
    public static void main(String[] args) {
        try {
            ...
            MessagingServer cs = new MessagingServer();
    ...
    public void connect(SerializedClass obj) {
        System.out.println(obj.getClientName());
        this.username = obj.getClientName();
        
       
        
        try {
            FileOutputStream fileOut = new FileOutputStream("chatmessagelog.txt");
